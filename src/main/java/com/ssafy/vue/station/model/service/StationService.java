...
public class StationService {
    ...
    public void initData() {
        try {
            ...
            insertLineData("남영",1);
            setConnectStation("남영","용산","서울역");
            insertLineData("서울역",1,4);
            setConnectStation("서울역","남영","시청","회현","숙대입구");
            insertLineData("시청",1);
            setConnectStation("시청","서울역","종각");
            insertLineData("종각",1);
            ...
            setConnectStation("망월사","도봉산","화룡");
            insertLineData("화룡",1);
            setConnectStation("화룡","망월사","의정부");
            insertLineData("의정부",1);
            setConnectStation("의정부","화룡");
            insertLineData("가산디지털단지",1);
            setConnectStation("가산디지털단지","구로","독산","철산","남구론");
            insertLineData("독산",1);
            ...
            setConnectStation("","안국","을지로3가","광화문","종각","종로5가","을지로4가");
